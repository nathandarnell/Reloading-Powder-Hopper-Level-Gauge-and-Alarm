...
I wrote a simple sketch to output the voltage of each pin the encoders are wired to.  It is from some code by Random Nerd Tutorials and adjusted for rotary encoders.  It needs an ESP32 and the encoder needs to have CLK and DT pins on once of these highlighted pins: <img src="/images/adc-pins-esp32-f.jpg" width="300" />
